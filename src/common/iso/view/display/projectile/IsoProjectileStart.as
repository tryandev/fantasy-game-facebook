package common.iso.view.display.projectile
{
	...
	public class IsoProjectileStart extends Sprite {
		
		// Class very similar to IsoProjectileEnd, but too early to combine!!!! trust me
		
		public static const ANI_FINISH:String = 'aniFinish';
		
		private var _mc:MovieClip;
		
		public function IsoProjectileStart(inMC:MovieClip, inX:Number, inY:Number) {
